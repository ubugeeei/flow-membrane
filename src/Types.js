...
export type TelemetryEventStart = {
  +url: URL,
  +method: HttpMethod,
};

export type TelemetryEventMatch = {
  +url: URL,
  +match: RouteMatch,
};

export type TelemetryEventEnd = {
  +url: URL,
  +method: HttpMethod,
...
export type TelemetryHooks = {
  +onDispatchStart?: (event: TelemetryEventStart) => mixed,
  +onMatch?: (event: TelemetryEventMatch) => mixed,
  +onDispatchEnd?: (event: TelemetryEventEnd) => mixed,
};
